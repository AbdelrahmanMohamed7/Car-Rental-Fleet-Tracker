...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
    ...
    try {
        ...
        if (!file.exists()) {
            JOptionPane.showMessageDialog(this, "Database file missing. Please register an account first.");
            return;
        }
        ...
        while (input.hasNextLine()) {
            ...
            // Ensure the line has the expected format: Full Name, Username, Password
            if (details.length >= 3) {
                String dbUsername = details[1].trim();
                String dbPassword = details[2].trim();
                
                if (uname.equals(dbUsername) && pass.equals(dbPassword)) {
                    found = true;
                    break; // Stop looking, we found a perfect match!
                }
            }
        }
        input.close();
        
        // Handle the login result ONE time outside of the loop
        if (found) {
            ...
            // Open the customer booking control panel directly
            CustomerBooking bookingPage = new CustomerBooking(); 
        } else {
